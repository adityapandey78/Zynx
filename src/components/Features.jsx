...
const Features = () => {
 ...
 <section className="bg-black pb-52">
    <div className='conatainer mx-auto px-3 md:px-10'>
        ...
        title={<>radia<b>n</b>t</>} 
        description={"A cross-platform metagame app. turing your activities across web2 and web3 games intoo a rewarding adventure."}/>
        </BentoTilt>
        ...
        <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
            ...
            <BentoTilt className='bento-tilt_2'>
                ...
                <h1 className='bento-title special_font max-w-64 text-black'>M<b>o</b>re Co<b>m</b>ing <b>S</b>oon!</h1>
